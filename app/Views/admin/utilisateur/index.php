                        ...
                        <tr>
                            ...
                            <td>
                                <div class="actions" style="justify-content:flex-end">
                                    <a href="<?= base_url('admin/utilisateurs/show/' . $u['id']) ?>" class="btn btn-ghost btn-sm">
                                        <svg viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                                        Voir
                                    </a>
                                    <a href="<?= base_url('admin/utilisateurs/edit/' . $u['id']) ?>" class="btn btn-ghost btn-sm">
...
<div class="modal-overlay" id="modal-delete">
    <div class="modal">
        ...
        <p>Voulez-vous vraiment supprimer le compte de <strong id="modal-user-name"></strong> ? Cette action est irréversible.</p>
