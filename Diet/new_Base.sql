...
CREATE TABLE regime_detail (
    ...
    prix            DECIMAL(10,2) NOT NULL,       -- prix regime/jours
    variation_poids DECIMAL(5,2) NOT NULL,        -- positif = prise, négatif = perte qui peut etre par jours ou plus
...
CREATE TABLE objectif (
    ...
    date_debut          DATE, -- Utile pour le backend
...
-- - on calcule les suggestions avec le programme
...
(2, 'Bob Martin',    'bob@mail.com',    '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1988-07-22', 'homme', 95.00, 1.80, 1, 50.00),
(2, 'Clara Rabe',    'clara@mail.com',  '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2000-11-05', 'femme', 50.00, 1.60, 0, 10.00),
(2, 'David Rakoto',  'david@mail.com',  '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1992-06-18', 'homme', 85.00, 1.78, 0, 0.00),
(2, 'Eva Rasolofo',  'eva@mail.com',    '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1998-09-30', 'femme', 60.00, 1.70, 0, 30.00);
...
('Course à pied', -1),      -- sport qui favorise la perte de poids
('Natation', -1),           -- sport neutre pour le poids
('Vélo', -1),               -- sport qui favorise la perte de poids 
('Musculation', 1),         -- sport qui favorise la prise de poids 
('basketball', -1),         -- sport qui favorise la perte de poids
('Yoga', 0);                -- sport neutre pour le poids
